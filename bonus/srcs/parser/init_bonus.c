...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/10 12:18:24 by hamzaelouar       #+#    #+#             */
/*   Updated: 2023/09/10 13:54:11 by hel-ouar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_floor_and_ceiling(t_infos *vars, int *vert_line)
{
	...
	while (i < RES_H)
	{
		if (i < RES_HALF_HEIGHT)
			vert_line[i] = vars->map->ceil->color_nb;
		else
